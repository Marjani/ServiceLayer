...
namespace MyApp.ServiceLayer.Common
{
    public interface ISettingApplicationService : IApplicationService
    {
        ...
        T LoadSetting<T>(int storeId = 0) where T : ISetting, new();
		...
		/// <param name="storeId">Store identifier</param>
		void SaveSetting<T>(T settings, int storeId = 0) where T : ISetting, new();
        ...
        void SaveSetting<T, TPropType>(T settings,
            ...
            int storeId = 0, bool clearCache = true) where T : ISetting, new();

        /// <remarks>codehint: sm-add</remarks>
        void UpdateSetting<T, TPropType>(T settings, Expression<Func<T, TPropType>> keySelector, bool overrideForStore, int storeId = 0) where T : ISetting, new();
        ...
        void DeleteSetting<T, TPropType>(T settings,
            Expression<Func<T, TPropType>> keySelector, int storeId = 0) where T : ISetting, new();
